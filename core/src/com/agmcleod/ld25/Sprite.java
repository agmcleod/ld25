...
public class Sprite {
    ...
    public void addAnimation(int[][] coords) {
        ...
        this.animations.add(new Animation<TextureRegion>(this.animationSpeed, frames));
    }
    ...
    public void drawHealthBar(ShapeRenderer renderer) {
        ...
        renderer.rect(this.x, this.y - 13, this.width, 8);
        renderer.end();
        renderer.begin(ShapeRenderer.ShapeType.Filled);
        renderer.setColor(Color.GREEN);
        renderer.rect(this.x+1, this.y - 12, (int) ((this.width * ((float) this.health / (float) this.maxHealth)) - 2), 6);
        renderer.end();
    }
