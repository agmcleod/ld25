...
public class OptionsScreen implements Screen, InputProcessor {
    ...
    public void render(float arg0) {
        ...
        if(focused) {
            ...
            shapeRenderer.rect(focusedBox.x, focusedBox.y, focusedBox.width, focusedBox.height);
            shapeRenderer.end();
        }
    ...
    public boolean touchDown(int x, int y, int arg2, int arg3) {
        ...
        while(entries.hasNext()) {
            ...
            if(bounds.contains(mousePos.x, mousePos.y)) {
                ...
                layout.setText(font, entry.key);
                this.focusedBox.setHeight(layout.height);
                this.focusedBox.setWidth(layout.width);
