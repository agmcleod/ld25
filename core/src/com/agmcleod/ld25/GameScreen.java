...
public class GameScreen implements Screen, InputProcessor {
    ...
    public void checkCollisions() {
        ...
        while(it.hasNext()) {
            ...
            if (Intersector.intersectRectangles(hero.getCollisionRectangle(), enemy.getCollisionRectangle(), overlap)) {
    ...
    public void initHero() {
        hero = new Hero(16 * 32, 12 * 32, 32, 32, characterImage, false);
    ...
    public void show() {
        ...
        // get resources
        grassImage = new Texture(Gdx.files.internal("grass.jpeg"));
        characterImage = new Texture(Gdx.files.internal("characters.png"));
        font = new BitmapFont(Gdx.files.internal("font.fnt"), Gdx.files.internal("font.png"), false);
        music = Gdx.audio.newMusic(Gdx.files.internal("My Song 2.mp3"));
